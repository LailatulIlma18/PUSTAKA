...
<head>
  ...
  <body>
   <div class="register-card text-center">
          ...
          <p style="font-size: 14px; margin-bottom:25px;">Daftarkan Akun <br> Masukkan Username dan Password</p>

          <form action="<?=base_url()?>register/proses_register" method="post">

            <div class="form-group has-feedback">
              <label>Nama Lengkap</label>
              <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama Lengkap Anda disini" required>
            ...
            <div class="form-group has-feedback">
              ...
              <button type="submit" class="btn btn-register btn-block">Daftar Sekarang</button>
               ...
               <p style="margin:15px 0 10px;">Atau Sudah Memiliki Akun ?</p>
               <a href="<?= base_url('login')?>" class="btn btn-login btn-block">Login</a>
          </form>
        </div>
